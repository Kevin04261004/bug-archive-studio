...
/* The name the finished file carries. A colon cannot be in a Windows file name and
   browsers drop it from a download name, so the title uses a dash in its place. */
const EPISODE_TITLE=code=>`C# QUIZ - ERROR ${code}`;
